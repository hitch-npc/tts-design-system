...
- **Футер** — три колонки: бренд и юридические ссылки / соцсети и контакт отдела продаж / возврат и поддержка;
  нижняя строка — копирайт и дисклеймер. В публичных файлах почта сотрудника — только заглушка `partners@example.com`.
