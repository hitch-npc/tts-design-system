...
**Версия `14.3.0`** · [история изменений](CHANGELOG.md) · [правила системы](CLAUDE.md) · [как менять токены](tooling/README.md)
...
| Передача фронтенду | `site/handoff/frontend-14.3.0.html` | Что изменилось в cookie-баннере и на странице партнёров в 14.3.0: было / стало, все состояния. Статичный файл для импорта в Figma (html.to.design) |
