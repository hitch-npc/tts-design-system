...
**Версия `14.3.1`** · [история изменений](CHANGELOG.md) · [правила системы](CLAUDE.md) · [как менять токены](tooling/README.md)
...
| Передача фронтенду | `site/handoff/frontend-14.3.1.html` | Что изменилось в cookie-баннере и на странице партнёров: стало, рядом прежний вариант, все состояния. Статичный файл для импорта в Figma (html.to.design) |
